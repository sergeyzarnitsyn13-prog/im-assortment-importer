...
const GROUPS = {
  ...
  electroluxOnOffSplits: 'Традиционные сплит-системы',
  householdMobiles: 'Бытовые мобильные кондиционеры',
  electroluxMobiles: 'Мобильные кондиционеры',
  industrialMobiles: 'Промышленные мобильные кондиционеры',
};

const createProfile = ({ id, brand = 'Ballu', group, productType, seriesName, code, aliases = [] }) => ({
  id,
  brand,
...
export const SERIES_PROFILES = [
  ...
  createProfile({
    id: 'electrolux-2026-dc-fusion-wave-super-dc-inverter',
    brand: 'Electrolux',
    group: GROUPS.inverterSplits,
    productType: 'splitSystem',
    seriesName: 'Fusion Wave Super DC Inverter',
    code: 'Fusion Wave Super DC Inverter',
    aliases: ['EACS/I-HFW', 'EACSI-HFW', 'HFW/N8'],
  }),
  createProfile({
    id: 'electrolux-2026-dc-smartline-dc-inverter',
    brand: 'Electrolux',
    group: GROUPS.inverterSplits,
    productType: 'splitSystem',
    seriesName: 'Smartline DC Inverter',
    code: 'HSM/N8_V3',
    aliases: ['EACS/I-HSM/N8_V3', 'EACSI-HSM/N8_V3'],
  }),
  createProfile({
    id: 'electrolux-2026-onoff-fusion-wave',
    brand: 'Electrolux',
    group: GROUPS.electroluxOnOffSplits,
    productType: 'splitSystem',
    seriesName: 'Fusion Wave',
    code: 'Fusion Wave',
    aliases: ['EACS-HFW'],
  }),
  createProfile({
    id: 'electrolux-2026-onoff-smartline',
    brand: 'Electrolux',
    group: GROUPS.electroluxOnOffSplits,
    productType: 'splitSystem',
    seriesName: 'Smartline',
    code: 'Smartline',
    aliases: ['EACS-HSM'],
  }),
  createProfile({
    id: 'electrolux-2026-mobile-arizona',
    brand: 'Electrolux',
    group: GROUPS.electroluxMobiles,
    productType: 'mobileAirConditioner',
    seriesName: 'Arizona',
    code: 'Arizona',
    aliases: ['EACM Arizona'],
  }),
  createProfile({
    id: 'electrolux-2026-mobile-loft',
    brand: 'Electrolux',
    group: GROUPS.electroluxMobiles,
    productType: 'mobileAirConditioner',
    seriesName: 'Loft',
  ...
  createProfile({
    id: 'electrolux-2026-mobile-cool-power',
    brand: 'Electrolux',
    group: GROUPS.electroluxMobiles,
    productType: 'mobileAirConditioner',
    seriesName: 'Cool Power',
    code: 'Cool Power',
    aliases: ['EACM Cool Power'],
  }),
  createProfile({
    id: 'electrolux-2026-mobile-ice-column',
    brand: 'Electrolux',
    group: GROUPS.electroluxMobiles,
    productType: 'mobileAirConditioner',
    seriesName: 'Ice Column',
    code: 'Ice Column',
    aliases: ['EACM Ice Column'],
  }),
];
